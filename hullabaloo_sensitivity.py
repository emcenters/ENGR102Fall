...
def sensitivity(consecutive_required):
    ...
    if consecutive_required <= 2:
        output_str[0] = "CAUGHT"
    if consecutive_required <= 3:
        output_str[1] = "CAUGHT"
    if consecutive_required <= 5:
        output_str[2] = "CAUGHT"
...
# it would lower the amount of false triggers. It also allows for the Hullbaloo
# bridge to remain stable in windy and/or critical conditions and stay intact.